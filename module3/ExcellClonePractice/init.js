...
let sheetsDB = [];
 let db;  //[[{},{},{}....{}][{},{},{}....{}]]
let visitedCells;//object
 //jab bhi initDb call hoga to new sheet ban jayegi
function initDb()
{
    let newSheetDB = [];
    for(let i=0; i<100; i++)
    {
        let row = []; //100 row array;
        for(let j=0; j<26; j++)
        {
...
// let sheetsDB = []; //har ek sheet ka db hoga 
// let db; //[[{},{},{}......{}],[[{},{},{}......{}],[[{},{},{}......{}]]
...
//             row.push(cellObject);
//         }
//         newSheetDB.push(row); // jo new bani hai usme push kar do
//     }
//     visitedCells = [];
//     db = newSheetDB;
//     sheetsDB.push({db:newSheetDB,visitedCells:visitedCells});
