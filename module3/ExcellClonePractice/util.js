//is file mai iske vo cfunction ya vo code hoga jo utilization ke kaam aayega 
...
//update children and calclulate again
function updateChildren(cellObject)
{
    for(let i=0; i<cellObject.children.length; i++)
    {
        let childName = cellObject.children[i];//name milega
        ...
        updateChildren(childCellObject);//call
    }
}
...
function removeFormula(cellObject)
{
    for(let i=0; i<cellObject.children.length; i++)
    {
        let parentName = cellObject.parrent[i];
